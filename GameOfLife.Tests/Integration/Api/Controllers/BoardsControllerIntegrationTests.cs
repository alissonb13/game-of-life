...
public class BoardsControllerIntegrationTests : IAsyncLifetime
{
    ...
    public BoardsControllerIntegrationTests()
    {
        ...
        services.AddScoped<IGetLatestBoardState, GetLatestBoardStateUseCase>();
        ...
        var getLatestBoardState = _serviceProvider.GetRequiredService<IGetLatestBoardState>();
    ...
    public async Task GetLatestBoardState_WithValidBoardId_ShouldReturnStableState()
    {
        ...
        var okResult = Assert.IsType<OkObjectResult>(result);
        Assert.IsType<GetLatestBoardStateOutput>(okResult.Value);
